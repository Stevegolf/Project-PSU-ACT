            ...
            <div class="row-fluid team">
                <div class="span4" id="first-person">
                    <div class="thumbnail">
                        ...
                        <div class="mask">
                            ...
                            <p>การแข่งขันกีฬามหาวิทยาลัย สีบลูเกมครั้งที่17</p>
                        </div>
                    </div>
                </div>
                <div class="span4" id="second-person">
                    <div class="thumbnail">
                        ...
                        <div class="mask">
                            <h2>ไหว้ครู 2016</h2>
                            <p>มหาวิทยาลัยสงขลานครินทร์ วิทยาเขตภูเก็ตจัดพิธีไหว้ครู เนื่องในวันครู</p>
                        </div>
                    </div>
                </div>
                <div class="span4" id="third-person">
                    <div class="thumbnail">
                        ...
                        <div class="mask">
                            <h2>การแข่งขันกีฬา 5 วิทยาเขต</h2>
                            <p>มหาวิทยาลัยสงขลานครินทร์ วิทยาเขตภูเก็ตร่วมการแข่งขันกีฬา 5 วิทยาเขต ณ ม.อ. สุราษฏร์</p>
                        </div>
                    </div>
                </div>
            </div>
